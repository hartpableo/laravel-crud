          ...
          @foreach ($posts as $post)
            ...
            <tr>
              ...
              <td>
                ...
                <a class="btn btn-sm btn-primary" href="{{route('posts.restore', $post->id)}}">Restore</a>
                <form action="{{route('posts.force_destroy', $post->id)}}" method="POST" class="d-inline">
                  @csrf
                  @method('DELETE')
                  <input type="submit" value="Delete Permanently" class="btn btn-sm btn-danger">
                </form>
              </td>
            </tr>
